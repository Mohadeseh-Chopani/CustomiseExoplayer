...
public class TrackSelectionView extends LinearLayout {
    ...
    @Nullable private QualityDialog.TrackSelectionViewFragment listener;
    ...
    public TrackSelectionView(
        ...
        disableView =
                (CheckedTextView)
                        inflater.inflate(R.layout.simple_list_item_single_choice, this, false);
    ...
    public void init(
            ...
            @Nullable QualityDialog.TrackSelectionViewFragment listener) {
